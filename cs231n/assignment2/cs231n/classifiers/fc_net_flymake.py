...
class TwoLayerNet(object):
	...
	def loss(self, X, y=None):
		...
		dx_2, grads['W2'], grads['b2'] = affine_relu_backward(dscores, cache2)
...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
        ...
        for i in range(0, self.num_layers):
            ...
            self.params[W_name] = np.random.normal(
                scale=weight_scale,
                size=(modif_hidden_dims[i], modif_hidden_dims[i+1]))
        ...
        for i in range(self.num_layers+1):
            ...
            if i == self.num_layers:
                ...
                scores, cache = affine_forward(
                    scores, self.params['W'+ str(i)], self.params['b' + str(i)])
            else:
                if self.use_batchnorm:
                    ## need to figure out this part
                    scores, self.batchnorm_cache['batchnorm' + str(i)] = batchnorm_forward(
                        scores, self.params['gamma' + str(i)],
